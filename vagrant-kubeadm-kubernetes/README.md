...
For the Spark Operations project, use this command guide:

```text
../docs/vagrant-commands.md
```

It includes cluster lifecycle, SSH access, provisioning, snapshots, VMware utility checks, and Kubernetes commands executed through `vagrant ssh`.
